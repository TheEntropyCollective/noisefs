...
func (analyzer *Milestone4ImpactAnalyzer) simulateLegacyOperation(cid string) bool {
...
func (analyzer *Milestone4ImpactAnalyzer) simulateModernOperation(cid string, iteration int) bool {
...
func (analyzer *Milestone4ImpactAnalyzer) calculateLegacyMetrics(results *PerformanceResults, totalTime time.Duration) {
...
func (analyzer *Milestone4ImpactAnalyzer) calculateModernMetrics(results *PerformanceResults, totalTime time.Duration) {
	results.SuccessRate = float64(results.SuccessfulOps) / float64(results.TotalOperations)
...
func (analyzer *Milestone4ImpactAnalyzer) printOverallConclusions() {
	...
	overallPerformance := (((float64(legacy.AverageLatency - modern.AverageLatency)) / float64(legacy.AverageLatency)) +
	...
	efficiencyGain := (((legacy.StorageOverhead - modern.StorageOverhead) / legacy.StorageOverhead) +
